...
// EXTERNAL MODULE: ./node_modules/lightweight-charts/dist/lightweight-charts.standalone.production.js
var lightweight_charts_standalone_production = __webpack_require__(126);
;// ./lib/app/logger.js
class Logger {
    constructor() {
        this._level = "none"
...
;// ./lib/app/series/series-cache.js
class SeriesCache extends Map {
...
;// ./lib/app/series/series-creation.js
...
;// ./lib/app/series/line-cache.js
class LineCache extends Map {
    
}
;// ./lib/app/series/line-service.js
...
;// ./lib/app/series/price-formatter.js
...
;// ./lib/app/series/series-instance.js
...
class SeriesInstanceService {
    ...
    _priceLineMethods() {
        return [
            new series_instance_PriceLineOptions(),
            new series_instance_PriceLineApplyOptions()
        ];
    }
...
class series_instance_PriceLineOptions extends PriceLineInstanceMethod {
    constructor() {
...
class series_instance_PriceLineApplyOptions extends PriceLineInstanceMethod {
    constructor() {
...
;// ./lib/app/series/series-function-manager.js





class SeriesFunctionManager {
...
;// ./lib/app/subscriptions-function-manager.js


class SubscriptionsFunctionManager {
...
;// ./lib/app/time-scale/tick-mark-formatter.js


class TickMarkFormatterService {
...
;// ./lib/app/time-scale/time-scale-instance.js




class TimeScaleInstanceService {
...
;// ./lib/app/time-scale/time-scale-function-manager.js


class TimeScaleFunctionManager {
...
;// ./lib/app/price-scale/price-scale-cache.js
/**
 * price scale cache
 * custom type for design custom methods
 */
class PriceScaleCache extends Map {
   
}
;// ./lib/app/price-scale/price-scale-creation.js




class PriceScaleCreationService {
...
class price_scale_creation_SeriesCreationMethod {
    constructor(name, invoke) {
        this.name = name;
        this.invoke = invoke;
    }
...
class PriceScaleChart extends price_scale_creation_SeriesCreationMethod {
    constructor(chart) {
...
class SeriesPriceScaleChart extends price_scale_creation_SeriesCreationMethod {
...
;// ./lib/app/price-scale/price-scale-instance.js



class PriceScaleInstanceService {
    ...
    _priceScaleInstanceMethods() {
        return [
            new price_scale_instance_ApplyOptions(),
            new PriceScaleWidth(),
        ];
    }
...
class price_scale_instance_ApplyOptions extends PriceScaleInstanceMethod {
    constructor() {
...
;// ./lib/app/price-scale/price-scale-function-manager.js




class PriceScaleFunctionManager {
...
;// ./lib/app/service-locator/locator-component.js
...
function initLocator(functionManager, pluginManager, chart) {
...
;// ./lib/app/service-locator/locator.js
...
;// ./lib/app/chart-registration-functions-controller.js
...
class ChartRegistrationFunctionsController {
...
;// ./lib/plugins/trend-line.js
// TrendLine Plugin for v4 - Android WebView compatible
class TrendLinePaneRenderer {
    ...
    _drawTextLabel(scope, text, x, y, left) {
        ...
        scope.context.fillRect(x + offset - leftAdjustment, y - 16, textWidth.width + offset * 2, 20);
